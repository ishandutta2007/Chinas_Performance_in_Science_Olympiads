...
# Historical IPhO Data for China (1998 - 2026)
# Format: (Year, China's Unofficial Rank, Total Participating Countries)
...
# Plot customization
plt.title(
    f"China's IPhO Performance Percentile ({ipho_data[0][0]} - {ipho_data[-1][0]})\nRelative Positioning to Overall Pool Size",
    fontsize=16,
    fontweight="bold",
    pad=15,
)
